...
public class DriverController
{
    ...
    public void selectCar(@PathVariable long driverId,@PathVariable long carId) throws EntityNotFoundException, InvalidStatusException, CarAlreadyInUseException
    {
    ...
    @PostMapping("/search")
    public List<DriverDTO> searchDriversByCriteria(@Valid @RequestBody SearchQueryDTO searchQueryDTO){
       return driverService.searchDriversByCriteria(searchQueryDTO);
    }
}
