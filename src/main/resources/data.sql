...
insert into manufacturer(id, date_created, name) values (2, now(), 'TATA');

-- cars
insert into car(id, date_created, license_plate, seat_count, convertible, rating, engine_type, manufacturer_id, selected,deleted)
values (1, now(), '123', 2, false, 3, 'GAS', 1, false,false);
insert into car(id, date_created, license_plate, seat_count, convertible, rating, engine_type, manufacturer_id, selected,deleted)
values (2, now(), '456', 7, true, 3, 'DIESEL', 2, true,false);
